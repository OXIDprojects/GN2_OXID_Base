...
( function ( $ ) {
    ...
    oxArticleVariant = {
        ...
        _create: function() {
           ...
           /*
            * FUNCTION FUER DROPDOWNS - GN2
            */
            $('.vardrop select').change(function(){
                ...
                if ( obj.parents().hasClass("js-fnSubmit") ){
                    ...
                    obj.parent('.vardrop').find('input:hidden').attr( "value", obj.attr("value") );
                    ...
                    if (($( "input[name=aid]", this ).val() == $( "input[name=parentid]", this ).val() )) {
                        ...
                        if (aSelectionInputs.length) {
                            ...
                            if ( jQuery.inArray( hash, oxVariantSelections ) ) {
                                return self.reloadProductPartially( $("form.js-oxProductForm"), 'detailsMain', $("#details"), $("#details")[0], $("body")[0]);
                            }
                        }
                    }
                    // alert($("#detailsMain")[0]);
        ...
        reloadProductPartially : function(activator, renderPart, highlightTargets, contentTarget, bodyTarget) {
