    ...
    oxMiniBasket = {
        ...
        _create: function(){
            ...
            if($("#newItemMsg").length > 0){
               $("#newItemMsg").css('display','block');
               $("#miniBasket #countValue").css('display','none');
               delay = 300;
			   setTimeout(function(){
					$("#miniBasket .counter").fadeOut(300,function(){
						$("#newItemMsg").remove();
						$("#miniBasket #countValue").css('display','block');
						$(this).fadeIn(500); 
					});
