...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    [{block name="email_html_order_owner_basketitem"}]
        ...
        <tr valign="top">
            <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                <img src="[{$basketproduct->getThumbnailUrl(false) }]" border="0" hspace="0" vspace="0" alt="[{$basketproduct->oxarticles__oxtitle->value|strip_tags}]" align="texttop">
            ...
            <table border="0" cellspacing="0" cellpadding="2" width="300">
                ...
                [{block name="email_html_order_owner_paymentcosts"}]
                    ...
                    [{if $basket->getPaymentCosts()}]
                        <tr valign="top">
                            <td style="padding: 5px; border-bottom: 2px solid #eed7c6;[{ if $basket->getDelCostVat() }]border-bottom: 1px solid #ddd;[{/if}]">
                                <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0;">
                            ...
                            <td style="padding: 5px; border-bottom: 2px solid #eed7c6;[{ if $basket->getDelCostVat() }]border-bottom: 1px solid #ddd;[{/if}]" align="right">
                                <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0;">
                        ...
                        [{if $basket->getDelCostVat() }]
                            <tr valign="top">
                                <td style="padding: 5px; border-bottom: 2px solid #eed7c6;">
                                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0;">
                                ...
                                <td style="padding: 5px; border-bottom: 2px solid #eed7c6;" align="right">
                                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0;">
...
[{block name="email_html_order_owner_bankdetails"}]
    [{if $payment->oxuserpayments__oxpaymentsid->value == "oxidpayadvance"}]
        ...
        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
            ...
            [{if $shop->oxshops__oxbiccode->value != ""}][{oxmultilang ident="EMAIL_ORDER_CUST_HTML_BIC" }] [{$shop->oxshops__oxbiccode->value}]<br>[{/if}]
            [{if $shop->oxshops__oxbiccode->value != ""}][{oxmultilang ident="EMAIL_ORDER_CUST_HTML_IBAN" }] [{$shop->oxshops__oxibannumber->value}][{/if}]
        </p>
    [{/if}]
[{/block}]
...
[{block name="email_html_order_owner_orderemailend"}]
