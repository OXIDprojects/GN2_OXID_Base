...
<form name="tobasket.[{$testid}]" [{if $blShowToBasket}]action="[{$oViewConf->getSelfActionLink()}]" method="post"[{else}]action="[{$productLink}]" method="get"[{/if}] class="js-oxProductForm">
    ...
    [{block name="widget_product_listitem_line_picturebox"}]
        <div class="pictureBox">
            <a class="sliderHover" href="[{$productLink}]" title="[{$product->oxarticles__oxtitle->value}] [{$product->oxarticles__oxvarselect->value}]"></a>
            <a href="[{$productLink}]" class="viewAllHover glowShadow corners" title="[{$product->oxarticles__oxtitle->value}] [{$product->oxarticles__oxvarselect->value}]"><span>[{oxmultilang ident="WIDGET_PRODUCT_PRODUCT_DETAILS"}]</span></a>
    ...
    <div class="infoBox">
        [{block name="widget_product_listitem_line_selections"}]
            <div class="info">
                <a id="[{$testid}]" href="[{$productLink}]" class="title" title="[{$product->oxarticles__oxtitle->value}] [{$product->oxarticles__oxvarselect->value}]">
