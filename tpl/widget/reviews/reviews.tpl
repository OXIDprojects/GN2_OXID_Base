[{gn2_oxscript include="js/widgets/oxrating.js" priority=10 }]
[{gn2_oxscript add="$( '#reviewRating' ).oxRating({openReviewForm: false, hideReviewButton: false});"}]
[{gn2_oxscript include="js/widgets/oxreview.js" priority=10 }]
        ...
        [{foreach from=$oView->getReviews() item=review name=ReviewsCounter}]
            <dl>
                [{block name="widget_reviews_record"}]
                    <dt id="reviewName_[{$smarty.foreach.ReviewsCounter.iteration}]" class="item">
                        <span>
