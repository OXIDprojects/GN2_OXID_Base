                ...
                [{else}]
                    [{block name="basket_btn_next_top"}]
                        <form action="[{$oViewConf->getSslSelfLink()}]" method="post">
                            ...
                            <a class="submitButton backToShop prevStep largeButton" href="[{$oViewConf->getHomeLink()}]">[{oxmultilang ident="PAGE_CHECKOUT_BASKET_CONTINUESHOPPING"}]</a>
...
[{include file="layout/page.tpl" sidebar="Left" checkoutStep=1}]