...
[{capture append="oxidBlock_content"}]
    <div class="accountDashboardView">
        ...
        <h2 class="pageHead accountHead">[{oxmultilang ident="PAGE_ACCOUNT_DASHBOARD_MYACCOUNT"}]"[{ $oxcmp_user->oxuser__oxusername->value }]"</h2>
        ...
        <p class="dashboardLogout"><a href="[{$oViewConf->getLogoutLink()}]" class="submitButton largeButton">[{oxmultilang ident="PAGE_ACCOUNT_DASHBOARD_LOGOUT"}]</a></p>
