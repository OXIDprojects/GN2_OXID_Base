<div class="compareItem">
    ...
    <a href="[{$productLink }]" class="picture" [{if $oView->noIndex() }]rel="nofollow"[{/if}]>
    ...
    <strong class="title">
        <a class="fn" href="[{$productLink }]" [{if $oView->noIndex() }]rel="nofollow"[{/if}]>[{$product->oxarticles__oxtitle->value}] [{$product->oxarticles__oxvarselect->value}]</a>
    </strong>
    ...
    <form name="tobasket.[{$testid}]" [{if $blShowToBasket}]action="[{$oViewConf->getSelfActionLink() }]" method="post"[{else}]action="[{$productLink}]" method="get"[{/if}]>
        <div class="variants">
            ...
            [{if $aVariantSelections && $aVariantSelections.selections }]
                <div class="selectorsBox js-fnSubmit" id="compareVariantSelections_[{$testid}]">
            ...
            [{elseif $oViewConf->showSelectListsInList()}]
                ...
                [{if $oSelections}]
                    <div class="selectorsBox js-fnSubmit" id="compareSelections_[{$testid}]">
        ...
        <div class="tobasket">
            ...
            <div class="tobasketFunction">
                ...
                [{else}]
                    <span >
                        <a id="variantMoreInfo_[{$testid}]" class="submitButton" href="[{$productLink }]" onclick="oxid.mdVariants.getMdVariantUrl('mdVariant_[{$testid}]'); return false;">[{oxmultilang ident="PAGE_PRODUCT_INC_PRODUCT_VARIANTS_MOREINFO"}]</a>
                    </span>
                [{/if}]
            </div>
