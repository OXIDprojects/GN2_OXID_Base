...
[{if $oView->getCompareItemsCnt() > 1 }]
    ...
    [{gn2_oxscript include="js/widgets/oxcompare.js" priority=10 }]
    [{gn2_oxscript add="$( '#compareList' ).oxCompare();"}]
...
[{else}]
  <p>[{oxmultilang ident="PAGE_PRODUCT_COMPARE_SELECTATLEASTTWOART"}]</p>
[{/if}]
