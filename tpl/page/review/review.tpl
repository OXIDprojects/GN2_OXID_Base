    ...
    [{if $oView->getProduct()}]
        ...
        <div class="lineView clear">
            ...
            <div class="pictureBox">
                <a class="sliderHover" href="[{$productLink }]" title="[{$product->oxarticles__oxtitle->value}]"></a>
                <a href="[{$productLink}]" class="viewAllHover glowShadow corners" title="[{$product->oxarticles__oxtitle->value}]"><span>[{oxmultilang ident="WIDGET_PRODUCT_PRODUCT_DETAILS"}]</span></a>
