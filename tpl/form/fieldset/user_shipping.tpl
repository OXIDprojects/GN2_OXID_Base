...
<li>
    ...
    [{gn2_oxscript include="js/widgets/oxusershipingaddressselect.js" priority=10 }]
    [{gn2_oxscript add="$( '#addressId' ).oxUserShipingAddressSelect();"}]
...
[{if $delivadr }]
    <li class="form" id="shippingAddressText">
        ...
        [{gn2_oxscript add="$('#userChangeShippingAddress').click( function() { $('#shippingAddressForm').show();$('#shippingAddressText').hide(); $('#userChangeShippingAddress').hide();return false;});"}]
    </li>
[{/if}]
