...
[{/if}]
[{gn2_oxscript include="js/widgets/oxcountrystateselect.js" priority=10 }]
[{gn2_oxscript add="$( '#`$countrySelectId`' ).oxCountryStateSelect({selectedStateId:'`$selectedStateId`'});"}]
