...
[{/if}]
    ...
    <li [{if $aErrors.oxuser__oxcompany}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_COMPANY" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxstreet}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_STREET_STREETNR" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxzip}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_ZIP_CITY" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxustid}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_VATIDNO" }]</span>
   ...
   [{block name="form_user_billing_country"}]
        ...
        <li [{if $aErrors.oxuser__oxcountryid}]class="oxInValid"[{/if}]>
            ...
            <p class="oxValidateError">
                <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_COUNTRY" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxfon}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_PHONE" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxfax}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_FAX" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxmobfon}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_CELLULARPHONE" }]</span>
    ...
    <li [{if $aErrors.oxuser__oxprivfon}]class="oxInValid"[{/if}]>
        ...
        <p class="oxValidateError">
            <span class="js-oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_PRIVATEPHONE" }]</span>
    ...
    [{if $oViewConf->showBirthdayFields() }]
        <li class="oxDate[{if $aErrors.oxuser__oxbirthdate}] oxInValid[{/if}]">
            ...
            <input placeholder="[{oxmultilang ident="DAY_2"}]" id="oxDay" class='oxDay js-oxValidate' name='invadr[oxuser__oxbirthdate][day]' type="text" data-fieldsize="xsmall" maxlength="2" value="[{if $iBirthdayDay > 0 }][{$iBirthdayDay }][{/if}]" />
            [{gn2_oxscript include="js/widgets/oxinnerlabel.js" priority=10 }]
            [{gn2_oxscript add="$( '#oxDay' ).oxInnerLabel({sReloadElement:'#userChangeAddress'});"}]
            ...
            <input placeholder="[{oxmultilang ident="YEAR"}]" id="oxYear" class='oxYear js-oxValidate' name='invadr[oxuser__oxbirthdate][year]' type="text" data-fieldsize="small" maxlength="4" value="[{if $iBirthdayYear }][{$iBirthdayYear }][{/if}]" />
            [{gn2_oxscript include="js/widgets/oxinnerlabel.js" priority=10 }]
            [{gn2_oxscript add="$( '#oxYear' ).oxInnerLabel({sReloadElement:'#userChangeAddress'});"}]
