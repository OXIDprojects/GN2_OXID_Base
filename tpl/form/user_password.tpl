...
<form class="js-oxValidate formUserPassw" action="[{ $oViewConf->getSelfActionLink() }]" name="changepassword" method="post">
    ...
    <ul class="form">
        <li [{if $aErrors.oxuser__oxpassword}]class="oxInValid"[{/if}]>
            ...
            <p class="oxValidateError">
                <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_OLDPASSWORD"}]</span>
        ...
        <li [{if $aErrors.oxuser__oxpassword}]class="oxInValid"[{/if}]>
            ...
            <p class="oxValidateError">
                <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_NEWPASSWORD"}]</span>
        ...
        <li [{if $aErrors.oxuser__oxpassword}]class="oxInValid"[{/if}]>
            ...
            <p class="oxValidateError">
                <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_NEWPASSWORD_CONFIRM"}]</span>
                <span class="js-oxError_length">[{oxmultilang ident="EXCEPTION_INPUT_PASSTOOSHORT"}]</span>
                <span class="js-oxError_match">[{oxmultilang ident="EXCEPTION_USER_PWDDONTMATCH"}]</span>
                [{include file="message/inputvalidation.tpl" aErrors=$aErrors.oxuser__oxpassword}]
            </p>
        ...
        <li class="formSubmit">
            <button id="savePass" type="submit" title="[{oxmultilang ident="FORM_USER_PASSWORD_SAVE" }]" class="submitButton">[{oxmultilang ident="FORM_USER_PASSWORD_SAVE"}]</button>
        </li>
    </ul>
</form>
