...
[{block name="user_checkout_noregistration"}]
    <form class="js-oxValidate formCheckoutNoRegister" action="[{$oViewConf->getSslSelfLink() }]" name="order" method="post">
    [{block name="user_checkout_noregistration_form"}]
        ...
        <div class="formCol checkoutNoRegisterCol">
            ...
            <div class="col left">
                ...
                <ul class="form">
                    ...
                    [{include file="form/fieldset/user_noaccount.tpl" markedFieldsNotice=true}]
                </ul>
            </div>
            
            <div class="col right">
                <h3 class="blockHead">[{oxmultilang ident="FORM_REGISTER_SHIPPINGADDRESS"}]</h3>
                <p><input class="checkbox" type="checkbox" name="blshowshipaddress" id="showShipAddress" [{if !$oView->showShipAddress()}]checked[{/if}] value="0"><label for="showShipAddress">[{oxmultilang ident="FORM_REGISTER_USE_BILLINGADDRESS_FOR_SHIPPINGADDRESS"}]</label></p>
