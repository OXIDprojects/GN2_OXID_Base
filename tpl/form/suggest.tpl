    ...
    <div>
        ...
        <ul class="form">
            <li>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_RECIPIENTNAME" }]</span>
                </p>
            </li>
            <li>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_RECIPIENTEMAIL" }]</span>
        ...
        <ul class="form">
            <li>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_NAME" }]</span>
                </p>
            </li>
            <li>
            ...
            <li>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_MESSAGE" }]</span>
                </p>
            </li>
            <li class="verify">
