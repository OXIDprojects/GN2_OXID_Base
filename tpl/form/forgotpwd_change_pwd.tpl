...
[{gn2_oxscript add="$('form.js-oxValidate').oxInputValidator();"}]
 <form class="js-oxValidate updatePassword" action="[{$oViewConf->getSelfActionLink() }]" name="order" method="post">
      ...
      <ul class="form">
            <li [{if $aErrors.oxuser__oxpassword}]class="oxInValid"[{/if}]>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_PASSWORD" }]</span>
            ...
            <li [{if $aErrors.oxuser__oxpassword}]class="oxInValid"[{/if}]>
                ...
                <p class="oxValidateError">
                    <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_PASSWORD_CONFIRM" }]</span>
                    <span class="js-oxError_length">[{oxmultilang ident="EXCEPTION_INPUT_PASSTOOSHORT" }]</span>
                    <span class="js-oxError_match">[{oxmultilang ident="EXCEPTION_USER_PWDDONTMATCH" }]</span>
                    [{include file="message/inputvalidation.tpl" aErrors=$aErrors.oxuser__oxpassword}]
                </p>
