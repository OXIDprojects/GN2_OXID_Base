    ...
    [{if !$oView->floodProtection() }]
        <form action="[{$oViewConf->getSelfActionLink()}]" method="post" id="rating">
            <div id="writeReview">
                ...
                <button id="reviewSave" type="submit" title="[{oxmultilang ident="FORM_GUESTBOOKENTRY_SEND"}]" class="submitButton">[{oxmultilang ident="FORM_GUESTBOOKENTRY_SEND"}]</button>
            </div>
        </form>
