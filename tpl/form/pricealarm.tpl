...
<form class="js-oxValidate" name="pricealarm" action="[{$oViewConf->getSelfActionLink() }]" method="post">
    ...
    <ul class="form">
        <li>
            ...
            <input class="js-oxValidate js-oxValidate_notEmpty textbox" type="text" name="pa[price]" value="[{oxhasrights ident="SHOWARTICLEPRICE"}][{if $product }][{$product->getFPrice() }][{/if}][{/oxhasrights}]" size="20" maxlength="32">
            <p class="oxValidateError">
                <span class="js-oxError_notEmpty">[{oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS_PRICEALARM" }]</span>
            </p>
        </li>
        <li>
            <label>[{ oxmultilang ident="FORM_PRICEALARM_EMAIL" }]:</label>
            <input class="js-oxValidate js-oxValidate_notEmpty js-oxValidate_email textbox" type="text" name="pa[email]" value="[{if $oxcmp_user }][{$oxcmp_user->oxuser__oxusername->value }][{/if}]" size="20" maxlength="128">
            <p class="oxValidateError">
        ...
        <li>
            ...
            [{/if}]
            <input class="js-oxValidate js-oxValidate_notEmpty textbox" type="text" data-fieldsize="verify" name="c_mac" value="">
            <p class="oxValidateError">
