...
[{block name="user_checkout_registration"}]
    <form class="js-oxValidate formCheckoutRegister" action="[{ $oViewConf->getSslSelfLink() }]" name="order" method="post">
    [{block name="user_checkout_registration_form"}]
        ...
        <div class="formCol checkoutRegisterCol">
            ...
            <div class="col left">
                ...
                <ul class="form">
                    ...
                    [{include file="form/fieldset/user_account.tpl" markedFieldsNotice=true}]
                </ul>
            </div>
